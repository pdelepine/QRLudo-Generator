...
class SGQuestionQCMNode extends SGNode
{
  static strokeColor = '#005700';
  /**
  ...
  displayQuestionZone ()
  {
    ...
    let txt_Title = myP5.createElement('label',"Nom de la question QCM :");
    ...
    this.btn_add_audio.mousePressed(() => { SGQuestionQCMNode.addAudio(self); });
    ...
    for (let i = 0; i < this.answers.length; i++)
    {
      ...
      btn_delete_answer.mousePressed(() => SGQuestionQCMNode.deleteAnswer(self,i));
    ...
    if (this.answers.length < 5)
    {
      ...
      this.btn_add_answer.mousePressed(() => { SGQuestionQCMNode.addAnswer(self); });
    ...
    this.btn_discard_modification.mousePressed(() => { SGQuestionQCMNode.discardModification(self); });
    ...
    this.btn_save_modification.mousePressed(() => { SGQuestionQCMNode.saveModification(self); });
   ...
   * @param {SGQuestionQCMNode} self, l'instance SGQuestionQCMNode qui s'affiche dans la zone
   */
  static addAnswer (self)
  {
    SGQuestionQCMNode.saveModification(self);
  ...
  {
    myP5.push();
    myP5.stroke(SGQuestionQCMNode.strokeColor);
    myP5.strokeWeight(4);
  ...
  clone ()
  {
    let nodecopy = new SGQuestionQCMNode(this.x,this.y,this.w,this.h);
